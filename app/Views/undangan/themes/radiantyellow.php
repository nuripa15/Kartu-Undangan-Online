...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/radiantyellow/css/bootstrap.min.css?SIDOINIKAHV2" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/radiantyellow/css/jquery.fancybox.css?SIDOINIKAHV2" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/radiantyellow/mdi/css/materialdesignicons.min.css?SIDOINIKAHV2">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/radiantyellow/css/style.css?SIDOINIKAHV2">
...
<div id="konten" style="z-index: 1;">
	...
	<div id="sampul-konten" class="konten" >                	
      	<table style="width: 100%;margin-top:-50px"> <!-- tambahkan margin-top:-XX jika kurang ketas -->
      		...
      		<tr>
      			<th style="text-align: center;">
                    <span class="nama-mempelai"><?php echo $row->nama_panggilan_pria; ?> & <?php echo $row->nama_panggilan_wanita; ?></span><br>
