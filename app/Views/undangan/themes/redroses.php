...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/redroses/css/bootstrap.min.css?SIDOINIKAHV2" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/redroses/css/jquery.fancybox.css?SIDOINIKAHV2" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/redroses/mdi/css/materialdesignicons.min.css?SIDOINIKAHV2">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/redroses/css/style.css?SIDOINIKAHV2">
	    ...
	    <div class="acaranya" >
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
						<!-- <img src="<?php echo base_url() ?>/assets/themes/redroses/img/akad-badge.png"> -->
			...
			<table class="tb-acara">
				<thead>
					...
					<!-- <img src="<?php echo base_url() ?>/assets/themes/redroses/img/resepsi-badge.png"> -->
