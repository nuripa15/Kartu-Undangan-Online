...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/greenflower/css/bootstrap.min.css?SIDOINIKAHV2" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/greenflower/css/jquery.fancybox.css?SIDOINIKAHV2" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/greenflower/mdi/css/materialdesignicons.min.css?SIDOINIKAHV2">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/greenflower/css/style.css?SIDOINIKAHV2">
...
<div class="dekorasi-all">
	...
	<!-- <img id="" src="<?php echo base_url() ?>/assets/themes/greenflower/img/top_flower.png" class="imgatas">  -->

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/greenflower/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<img src="<?php echo base_url() ?>/assets/themes/greenflower/img/kanan-atas.png" class="imgatas-kanan"> 
</div>
      	...
      	<table style="width: 100%;margin-top:-50px"> <!-- tambahkan margin-top:-XX jika kurang ketas -->
            ...
            <tr>
                <th style="position: relative;text-align: center;display:block;margin-top:50px">
					...
					<!-- image border cover -->
                    <img src="<?= base_url() ?>/assets/themes/greenflower/img/bg-flower.png" class="cover-border" /><br>
					<!-- image border cover -->
    ...
    <div id="acara-konten" style="display: none;" class="konten">
	    ...
	    <div class="acaranya" >
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
						<!-- <img src="<?php echo base_url() ?>/assets/themes/greenflower/img/akad-badge.png"> -->
						- AKAD NIKAH -
					</th>
				</thead>
				<tbody>
			...
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
					<!-- <img src="<?php echo base_url() ?>/assets/themes/greenflower/img/resepsi-badge.png"> -->
					- RESEPSI -
					</th>
				</thead>
				<tbody>
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<!-- <img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/greenflower/img/bottom_flower.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/greenflower/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/greenflower/img/kiri-bawah.png" > 
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/greenflower/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/greenflower/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/greenflower/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/greenflower/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/greenflower/js/script.js"></script>
