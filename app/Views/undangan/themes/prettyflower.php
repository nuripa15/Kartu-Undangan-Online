...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/prettyflower/css/bootstrap.min.css?SIDOINIKAHV2" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/prettyflower/css/jquery.fancybox.css?SIDOINIKAHV2" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/prettyflower/mdi/css/materialdesignicons.min.css?SIDOINIKAHV2">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/prettyflower/css/style.css?SIDOINIKAHV2">
    ...
    <div id="acara-konten" style="display: none;" class="konten">
	    ...
	    <div class="acaranya" >
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
						<!-- <img src="<?php echo base_url() ?>/assets/themes/prettyflower/img/akad-badge.png"> -->
						- AKAD NIKAH -
					</th>
				</thead>
				<tbody>
			...
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
					<!-- <img src="<?php echo base_url() ?>/assets/themes/prettyflower/img/resepsi-badge.png"> -->
					- RESEPSI -
					</th>
				</thead>
				<tbody>
